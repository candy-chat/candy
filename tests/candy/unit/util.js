...
define([
	...
	bdd.describe('Candy.Util', function () {
		...
		bdd.describe('escapeJid', function () {
			...
			// Skip this for now. See https://github.com/theintern/intern/pull/195
			bdd.skip('should escape JIDs per XEP-0106', function () {
		...
		bdd.describe('Parser', function () {
			bdd.describe('jid', function () {
				...
				// Skip this for now. See https://github.com/theintern/intern/pull/195
				bdd.skip('should parse JIDs per RFC6122', function () {
