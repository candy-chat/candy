...
Candy.View.Pane = (function(self) {
  ...
  self.Window = {
     ...
     * Document title
     */
    _plainTitle: Candy.Util.getParentWindow().document.title,
    ...
    clearUnreadMessages: function() {
      ...
      Candy.Util.getParentWindow().document.title = self.Window._plainTitle;
    },
    ...
    renderUnreadMessages: function(count) {
      Candy.Util.getParentWindow().document.title = Candy.View.Template.Window.unreadmessages.replace('{{count}}', count).replace('{{title}}', self.Window._plainTitle);
    },
